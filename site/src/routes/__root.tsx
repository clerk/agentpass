...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: 'og:image', content: 'https://agentpass.com/og.png' },
      { property: 'og:url', content: 'https://agentpass.com' },
      { property: 'og:logo', content: 'https://agentpass.com/AgentPass.svg' },
      ...
      { name: 'twitter:image', content: 'https://agentpass.com/og.png' },
    ],
    links: [
