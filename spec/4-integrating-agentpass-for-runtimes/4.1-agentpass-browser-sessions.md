...
- `POST {service_provider_configuration_url}/resolve-deployments`
...
- `POST {agentpass_configuration_url}/requests`

Where `agentpass_configuration_url` is the `agentpass_configuration_url` of the selected deployment returned from `POST {service_provider_configuration_url}/resolve-deployments`.
...
- `GET {agentpass_configuration_url}/requests/{id}`
...
- `POST {service_provider_configuration_url}/init`
...
If `POST {service_provider_configuration_url}/init` succeeds, Runtime receives `initialization_url`.
